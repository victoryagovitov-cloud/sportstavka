...
class ManualLiveProvider:
    ...
    def get_current_live_matches(self) -> List[Dict[str, Any]]:
        ...
        current_matches = [
            ...
            # 🎾 ТЕННИСНЫЕ МАТЧИ (точно как на реальных сайтах)
            {
                'team1': 'de Groot D / Zhu Zhe',
                'team2': 'Li X / Wang Z',
                'score': '0:1, 1:1',
                'time': '2nd set',
                'sport': 'tennis',
                'league': 'US Open, Wheelchairs, Women Doubles',
                'importance': 'HIGH',
                'source': 'manual_verified',
                'region': 'USA',
                'tournament_type': 'Grand Slam',
                'status': 'LIVE',
                'betting_significance': 'HIGH - US Open wheelchair tennis',
                'surface': 'Outdoor hard',
                'match_duration': '01:00'
            },
            {
                'team1': 'L. Fullana',
                'team2': 'M. E. Reasco Gonzalez',
                'score': '0:1, 1:1',
                'time': '2nd set',
                'sport': 'tennis',
                'league': 'ITF W35 Cuiaba Women',
                'importance': 'LOW',
                'source': 'manual_verified',
                'region': 'Brazil',
                'tournament_type': 'ITF',
                ...
                'countries': {'team1': 'Brazil', 'team2': 'Ecuador'}
            },
            {
                'team1': 'J. Prachar',
                'team2': 'R. Mishiro',
                ...
                'time': '2nd set',
                'sport': 'tennis',
                'league': 'UTR PTT Denver Men 02, Group B',
                'importance': 'MEDIUM',
                'source': 'manual_verified',
                'region': 'USA',
                'tournament_type': 'Professional',
                'status': 'LIVE',
                'betting_significance': 'MEDIUM - UTR Pro Tennis Tour',
                'surface': 'Outdoor hard',
                'match_duration': '00:25',
                'countries': {'team1': 'Czechia', 'team2': 'Japan'}
            },
            {
                'team1': 'S. Patel',
                'team2': 'M. Olivero',
                ...
                'time': '2nd set',
                'sport': 'tennis',
                'league': 'UTR PTT Urbana Men 02, Group C',
                'importance': 'MEDIUM',
                'source': 'manual_verified',
                'region': 'USA',
                'tournament_type': 'Professional',
                ...
                'betting_significance': 'MEDIUM - UTR Pro Tennis Tour',
                'surface': 'Outdoor hard',
                'match_duration': '01:15',
                'countries': {'team1': 'USA', 'team2': 'Chile'}
            },
            {
                'team1': 'D. Kakhniuk',
                'team2': 'L. Bowden',
                ...
                'time': '2nd set',
                'sport': 'tennis',
                'league': 'UTR PTT Waco Men 04, Group A',
                'importance': 'MEDIUM',
                'source': 'manual_verified',
                'region': 'USA',
                'tournament_type': 'Professional',
                ...
                'betting_significance': 'MEDIUM - UTR Pro Tennis Tour',
                'surface': 'Outdoor hard',
                'match_duration': '00:35',
                'countries': {'team1': 'USA', 'team2': 'United Kingdom'}
            },
            {
                'team1': 'A. Sandrone',
                'team2': 'I. V. Enoma',
                ...
                'time': '3rd set',
                'sport': 'tennis',
                'league': 'UTR PTT Waco Men 04, Group C',
                'importance': 'MEDIUM',
                'source': 'manual_verified',
                'region': 'USA',
                'tournament_type': 'Professional',
                ...
                'betting_significance': 'MEDIUM - UTR Pro Tennis Tour',
                'surface': 'Outdoor hard',
                'match_duration': '01:05',
                'countries': {'team1': 'Italy', 'team2': 'Spain'}
            },
            {
                'team1': 'P. M. Rebec',
                'team2': 'L. Alexin',
                ...
                'time': '2nd set',
                'sport': 'tennis',
                'league': 'UTR PTT Denver Women 02, Group C',
                'importance': 'LOW',
                'source': 'manual_verified',
                'region': 'USA',
                'tournament_type': 'Professional',
                ...
                'surface': 'Outdoor hard',
                'match_duration': '00:45',
                'countries': {'team1': 'Slovenia', 'team2': 'USA'}
            },
